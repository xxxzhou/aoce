...
inline __host__ __device__ uchar4 operator*(uchar4 a, float b) {
    uchar x = (uchar)clamp((int)(a.x * b), 0, 255);
    uchar y = (uchar)clamp((int)(a.y * b), 0, 255);
    uchar z = (uchar)clamp((int)(a.z * b), 0, 255);
    uchar w = (uchar)clamp((int)(a.w * b), 0, 255);
    return make_uchar4(x, y, z, w);
}
inline __host__ __device__ uchar4 operator+(uchar4 a, uchar4 b) {
    uchar x = (uchar)clamp(a.x + b.x, 0, 255);
    uchar y = (uchar)clamp(a.y + b.y, 0, 255);
    uchar z = (uchar)clamp(a.z + b.z, 0, 255);
    uchar w = (uchar)clamp(a.w + b.w, 0, 255);
    return make_uchar4(x, y, z, w);
}
